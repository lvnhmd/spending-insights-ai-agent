...
exports.sanitizeTransactionData = sanitizeTransactionData;
exports.containsPII = containsPII;
exports.getPIIRiskScore = getPIIRiskScore;
exports.validateRedaction = validateRedaction;
exports.batchSanitizeTransactions = batchSanitizeTransactions;
/**
 ...
 */
function sanitizeTransactionData(text) {
    ...
    for (const [piiType, patterns] of Object.entries(PII_PATTERNS)) {
        for (const pattern of patterns) {
            ...
            while ((match = regex.exec(result.redactedText)) !== null) {
                ...
                const redactedValue = generateRedactedValue(piiType, originalValue);
 ...
 */
function generateRedactedValue(piiType, originalValue) {
 ...
 */
function validateRedaction(original, redacted) {
 ...
 */
function batchSanitizeTransactions(descriptions) {
