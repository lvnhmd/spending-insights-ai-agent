...
describe('Database Operations', () => {
    ...
    describe('Transaction Operations', () => {
        ...
        it('should create a transaction successfully', async () => {
            ...
            await expect((0, index_1.createTransaction)(sampleTransaction)).resolves.not.toThrow();
        ...
        it('should get a transaction by ID', async () => {
            ...
            const result = await (0, index_1.getTransaction)(testUserId, sampleTransaction.id, sampleTransaction.date);
        ...
        it('should return null for non-existent transaction', async () => {
            mockDocClient.send.mockResolvedValueOnce({});
            const result = await (0, index_1.getTransaction)(testUserId, 'non-existent', new Date());
        ...
        it('should batch create multiple transactions', async () => {
            ...
            await expect((0, index_1.batchCreateTransactions)(transactions)).resolves.not.toThrow();
    ...
    describe('Weekly Insights Operations', () => {
        ...
        it('should create a weekly insight successfully', async () => {
            mockDocClient.send.mockResolvedValueOnce({});
            await expect((0, index_1.createWeeklyInsight)(sampleInsight)).resolves.not.toThrow();
            expect(mockDocClient.send).toHaveBeenCalledTimes(1);
        });
        it('should get a weekly insight', async () => {
            ...
            mockDocClient.send.mockResolvedValueOnce({ Item: mockRecord });
            const result = await (0, index_1.getWeeklyInsight)(testUserId, sampleInsight.weekOf);
            expect(result).toBeTruthy();
    ...
    describe('Agent Memory Operations', () => {
        ...
        it('should set and get session memory', async () => {
            ...
            await (0, index_1.setSessionMemory)(testUserId, 'session-123', {
                conversationHistory: [sampleConversationTurn],
            });
            const result = await (0, index_1.getSessionMemory)(testUserId);
            expect(result).toBeTruthy();
        ...
        it('should handle memory scopes correctly', async () => {
            mockDocClient.send.mockResolvedValueOnce({});
            await (0, index_1.setAgentMemory)(testUserId, index_1.MEMORY_SCOPES.PREFERENCES, {
                learnedPreferences: [
                    {
    ...
    describe('User Profile Operations', () => {
        ...
        it('should create a user profile successfully', async () => {
            mockDocClient.send.mockResolvedValueOnce({});
            await expect((0, index_1.createUserProfile)(sampleProfile)).resolves.not.toThrow();
            expect(mockDocClient.send).toHaveBeenCalledTimes(1);
        });
        it('should get a user profile', async () => {
            ...
            mockDocClient.send.mockResolvedValueOnce({ Item: mockRecord });
            const result = await (0, index_1.getUserProfile)(testUserId);
            expect(result).toBeTruthy();
        ...
        it('should create default profile if none exists', async () => {
            ...
            const result = await (0, index_1.getOrCreateUserProfile)(testUserId);
            expect(result).toBeTruthy();
    ...
    describe('Error Handling', () => {
        it('should handle DynamoDB errors gracefully', async () => {
            ...
            await expect((0, index_1.getUserProfile)(testUserId)).rejects.toThrow('Table not found');
        });
        it('should handle validation errors', async () => {
            const error = new Error('ValidationException: Invalid parameter');
            error.name = 'ValidationException';
            mockDocClient.send.mockRejectedValueOnce(error);
            await expect((0, index_1.getUserProfile)(testUserId)).rejects.toThrow('Invalid parameters');
        });
    });
});
...
describe('Integration Tests (requires deployed tables)', () => {
    ...
    it.skip('should perform end-to-end transaction flow', async () => {
        ...
        // Test create
        await (0, index_1.createTransaction)(transaction);
        // Test retrieve
        const retrieved = await (0, index_1.getTransaction)(userId, transactionId, transaction.date);
        expect(retrieved).toBeTruthy();
        expect(retrieved?.amount).toBe(transaction.amount);
        // Test weekly query
        const weeklyTransactions = await (0, index_1.getTransactionsByWeek)(userId, transaction.date);
